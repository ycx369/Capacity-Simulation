...
namespace BomChange
{
    ...
    {
        //static string strCon = @"Server=10.177.118.249;Database=whbom;User=root;Password=root;allow zero datetime = true;Charset=utf8";
        ...
        {
            MySqlConnection scon = new MySqlConnection(strCon);//创建数据库连接对象
